...
module.exports = function getData(week, weekday) {
    var baseURL = 'http://www.juvenes.fi/DesktopModules/Talents.LunchMenu/LunchMenuServices.asmx/GetMenuByWeekday?KitchenId=60038&MenuTypeId=77&Week='
  ...
  .then(function(stories) {
    ...
    return ({"Cafe_Konehuone" :[linjasto1, linjasto1_diet, linjasto2, linjasto2_diet]});
  });
};