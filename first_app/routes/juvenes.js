...
module.exports = function getData(week, weekday) {
    var baseURL = 'http://www.juvenes.fi/DesktopModules/Talents.LunchMenu/LunchMenuServices.asmx/GetMenuByWeekday?KitchenId=6&MenuTypeId=60&Week='
  ...
  .then(function(stories) {
    ...
    return ({"Juvenes" :[linjasto1, linjasto1_diet, linjasto2, linjasto2_diet]});
  });
};